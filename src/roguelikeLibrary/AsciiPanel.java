 ...
 *
 * adding another instance of this .java allows us to create more colours for the library -garett
 *
 */
public class AsciiPanel extends JPanel {
     ...
     * Added by garett
     *
     * Brighter colour for the tallgrass tile
     */
    public static Color grassColour = new Color(13, 186,0);
    public static Color ogreColour = new Color(1, 75, 23);
    public static Color trollColour = new Color(254, 106, 15);
    public static Color golemColour = new Color(145, 80, 41);
    public static Color dragonColour = new Color(255, 3, 0);
    public static Color giantColour = new Color(0, 47, 40);
